...
module modulator(
  ...
  input signed  [`SinSize-1:0]  sin,
  input signed  [`SinSize-1:0]  cos,
  output reg signed [`SinSize-1:0]  I_out,
  output reg signed [`SinSize-1:0]  Q_out
  );
  ...
  reg signed  [`IQ_length-1:0]  I_com, Q_com;
