...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll_64_new -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00g -type pll -fin 64.00 -clkibuf LVDS -fclkop 64.00 -fclkop_tol 0.1 -phase_cntl STATIC -rst -lock -fb_mode 1 -fdc C:/Users/SNA/Documents/FPGA_code/lattice_sdr_code/pll_64m/pll_64_new/pll_64_new.fdc  */
/* Sat Jan 03 21:16:32 2026 */


`timescale 1 ns / 1 ps
module pll_64_new (CLKI, RST, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire LOCK;
