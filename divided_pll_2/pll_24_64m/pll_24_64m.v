...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll_24_64m -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00g -type pll -fin 24.00 -fclkop 64.00 -fclkop_tol 0.0 -phase_cntl STATIC -rst -lock -fb_mode 1 -fdc C:/Users/SNA/Documents/FPGA_code/lattice_sdr_code/divided_pll_2/pll_24_64m/pll_24_64m.fdc  */
/* Sun Jan 04 00:12:37 2026 */


`timescale 1 ns / 1 ps
module pll_24_64m (CLKI, RST, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire LOCK;
