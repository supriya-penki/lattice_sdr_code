...
component creating_nco is
    port (sincos_m_Cosine: out std_logic_vector(7 downto 0);
...
_inst: creating_nco port map (sincos_m_Cosine => __,sincos_m_Sine => __,sincos_m_Theta => __,
            sincos_m_ClkEn => __,sincos_m_Clock => __,sincos_m_Reset => __);
