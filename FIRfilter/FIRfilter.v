...
//
// Verific Verilog Description of module FIRfilter
//
module FIRfilter (rcosfilter_m_din, rcosfilter_m_dout, rcosfilter_m_clk, 
            rcosfilter_m_inpvalid, rcosfilter_m_outvalid, rcosfilter_m_rfi, 
            rcosfilter_m_rstn) /* synthesis sbp_module=true */ ;
    input [3:0]rcosfilter_m_din;
    output [25:0]rcosfilter_m_dout;
